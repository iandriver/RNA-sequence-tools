...
path = '/Volumes/Drobo/Seq_data/rsem_pteng'
result_file_names = ['rsem_pengt_2nd','rsem_pteng_1st']
basename = 'rsem_m38_macs_cfms_pnxd7'
cell_list =[]
        ...
        for filename in fnmatch.filter(filenames, '*.o*'):
            ...
            for l in f:
                if 'reads; of these:' in l:
                    ...
                    check_file =True
                if 'aligned concordantly 0 times' in l:
                ...
                if "aligned concordantly >1 times" in l:
                    ...
                    concordg1_per2 = concord0_per1.split('(')[-1].strip('%')
