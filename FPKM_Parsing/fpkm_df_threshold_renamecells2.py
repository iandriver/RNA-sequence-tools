...
def filter_by_mapping(path_to_align, cutoff_per_map = 200000):
    c_to_del =[]
...
def filter_cells_sd(by_cell, cell_list, sd=1.8):
    average_gene_exp = []
    to_delete= []
...
path_to_file = '/Volumes/Seq_data/chapman_countbased'
file_name = 'chapman_hu_all_count_table.txt'
base_name ='hu_chapman_counts'
...
path_to_align=os.path.join(path_to_file,'results_chapman_hu_all_align.p')
