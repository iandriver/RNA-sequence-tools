...
path = '/Volumes/Seq_data/results_spc1_ctrl_pnx'
align_dict={}
cell_list =[]
...
align_df.to_csv(os.path.join(path,'results_spc1_align.txt'), sep = '\t')

with open(os.path.join(path,'results_spc1_align.p'), 'wb') as fp:
