run_monocle <- function(dir){
	...
	print(sig_genes_cond[,c("GeneID", "pval", "qval")])
	...
	dev.off()
	pdf('marker_genes_psuedotime2.pdf')
	...
	dev.off()
	saveRDS(my_data, "monocle_data_hu_ht280.rds")
	}
